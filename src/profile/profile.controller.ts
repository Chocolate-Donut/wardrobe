import { Controller, Post, UseInterceptors, UploadedFile, Req, UseGuards, Get, Patch,  Body} from '@nestjs/common';
...
export class ProfileController {
  ...
  @Patch()
@UseGuards(AuthGuard('jwt'))
async updateProfile(@Req() req: Request, @Body() body: { username: string }) {
  const user = req.user as any;
